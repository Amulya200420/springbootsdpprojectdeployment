        ...
        <div class="row center_o1">
            <div class="col-md-5">
                <div class="center_o1l">
                    <h2 class="mb-0">Counselling after 10th</h2>
                </div>
            </div>
            <div class="col-md-7">
                ...
                <div class="prod_main p-1 bg-white clearfix">
                        ...
                        <div class="product_2imi clearfix">
                            <div class="grid clearfix">
                                <figure class="effect-jazz mb-0">
                                    <a href=""><img src="image/c4.jpg" class="w-100" alt="abc"></a>
                                </figure>
                            </div>
                        </div>
                    ...
                    <div class="product_2im1 position-relative clearfix">
                        <div class="clearfix product_2im1i text-center pt-3 pb-4">
                            <h5 class="font_14 text-uppercase"><a class="col_dark" href="product_detail">Dr Ritu Sharma</a></h5>
                ...
                <div class="prod_main p-1 bg-white clearfix">
                    <div class="product_2im clearfix position-relative">
                        <div class="product_2imi clearfix">
                            <div class="grid clearfix">
                                <figure class="effect-jazz mb-0">
                                    <a href=""><img src="image/c5.jpg" class="w-100" alt="abc"></a>
                                </figure>
                            </div>
                        </div>
                    ...
                    <div class="product_2im1 position-relative clearfix">
                        <div class="clearfix product_2im1i text-center pt-3 pb-4">
                            <h5 class="font_14 text-uppercase"><a class="col_dark" href="product_detail">Dr Diksha Arora</a></h5>
                ...
                <div class="prod_main p-1 bg-white clearfix">
                    <div class="product_2im clearfix position-relative">
                        <div class="product_2imi clearfix">
                            <div class="grid clearfix">
                                <figure class="effect-jazz mb-0">
                                    <a href=""><img src="image/c6.jpg" class="w-100" alt="abc"></a>
                                </figure>
                            </div>
                        </div>
                    ...
                    <div class="product_2im1 position-relative clearfix">
                        <div class="clearfix product_2im1i text-center pt-3 pb-4">
                            <h5 class="font_14 text-uppercase"><a class="col_dark" href="product_detail1.jsp">Dr Aarav Roy </a></h5>
